...
public class AdminUser extends com.cemenghui.system.entity.User {
    ...
    private com.cemenghui.system.entity.User registerThirdPartyUser(String platform, String openId) {
        // 实现自动注册逻辑
