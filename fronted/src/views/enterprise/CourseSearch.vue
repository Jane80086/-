...
const courses = ref([
  { id: 1, title: '前端开发入门', description: '学习HTML、CSS、JavaScript基础', instructorName: '张老师', duration: 120, price: 0, imageUrl: '', viewCount: 1234, rating: 4.5, category: '前端开发', level: '初级' },
  { id: 2, title: 'Java后端实战', description: 'Spring Boot+MyBatis企业级开发', instructorName: '李老师', duration: 180, price: 99, imageUrl: '', viewCount: 888, rating: 4.8, category: '后端开发', level: '中级' },
])
